package com.bank.islamic.qardhassanaccount.model;
...
/**
 * The BIAN control record for this service domain: "Qard Hassan Account Fulfillment Arrangement".
 *
 ...
 * to its asset type (Qard Hassan Account). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Qard Hassan Account Fulfillment Arrangement";
